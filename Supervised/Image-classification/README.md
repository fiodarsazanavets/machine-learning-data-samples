...
## Images-labelled-folders

This folder contains various subfolders with images. Each subfolder represents an individual label category. Images within each folder belong to the same class.
